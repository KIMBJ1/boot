...
public class StartView {
	...
	public static void main(String[] args) {
		...
		// step02 개선
		// controller로 이관 예정
		// service 클래스에서 TalentDonationProjectService 67 line코드 적용
		...
		// 객체 or ProjectNotFoundException 발생
...
//		EndView.projectView(project);
		...
		controller.donationProjectUpdate("01슈바이처", donator3);// 갱신 + 검색
//		controller.getDonationProject("01슈바이처"); // 검색을 다시 할 필요 없음
